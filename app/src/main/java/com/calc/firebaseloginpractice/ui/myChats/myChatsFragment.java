package com.calc.firebaseloginpractice.ui.myChats;
...
public class myChatsFragment extends Fragment
{
    ...
    // i have to create xml like usersfragment xml and conect it here and javaclass like chatfragment will call it mycharfragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mainView= inflater.inflate(R.layout.fragment_mychats,null);
        return mainView;
    }
    @Override
    ...
    private void getUsers()
    {
        ...
        constants.getDatabaseReference().child("MyChats").child(constants.getUid(requireActivity())).addValueEventListener(new ValueEventListener()
        {
    ...
    {
        recyclerView=mainView.findViewById(R.id.mycha_recycler);
    ...
    private class usersAdapter extends RecyclerView.Adapter<usersAdapter.VH>
    {
        ...
        public usersAdapter.VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(requireContext()).inflate(R.layout.item_mychats, parent, false);
            return new usersAdapter.VH(view);
        }

        @Override
        public void onBindViewHolder(@NonNull final usersAdapter.VH holder, int position)
        {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                {
                    constants.replaceFragment(myChatsFragment.this, new chatsFragment(),true);
        ...
        private class VH extends RecyclerView.ViewHolder
        {
            ...
            VH(@NonNull View itemView) {
                ...
                userName=itemView.findViewById(R.id.user_mychats_name);
                userAddress=itemView.findViewById(R.id.user_mychats_address);
                userImage=itemView.findViewById(R.id.user_mychats_image);
//                seenOne=itemView.findViewById(R.id.users_mychats_seen_one);
//                seenTwo=itemView.findViewById(R.id.users_mychats_seen_two);
//                time=itemView.findViewById(R.id.users_mychats_time_text);
//                messageTv=itemView.findViewById(R.id.message_mychats_filed);
            }
        }
    }
}
